...
$(document).ready(function() {
		...
		var $videoWrapper = $('<div id="videoWrapper"></div>');
		var $video = $('<iframe width="960" height="540" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
		...
		$(".pictureWrapper a").click(function(event){
			event.preventDefault();
